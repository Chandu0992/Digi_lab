...
public class GenerateReports extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_month_export.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_month_exportActionPerformed(evt);
            }
        });

        jLabel9.setText("Ex: - (2017%)");
    ...
    private void btn_day_exportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_day_exportActionPerformed
        ...
        String sql = "SELECT * into OUTFILE 'C:/Users/Raju/Documents/DayReports/"+cd.getText()+"_day_wise_report.xls' from issue_books where Issue_Date ='"+cd.getText()+"'";
        try{
...
public void CurrentDate(){
    ...
    private void btn_date_exportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_date_exportActionPerformed
        // TODO add your handling code here:
        String sql = "SELECT * into OUTFILE 'C:/Users/Raju/Documents/MonthWiseReports/"+cd.getText()+"_date_wise_reports.xls' from issue_books where Issue_Date BETWEEN '"+start_date.getText()+"' and '"+end_date.getText()+"'";
        try{
            pst=conn.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(rootPane,"Export Sucessfully");
    ...
    private void btn_month_exportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_month_exportActionPerformed
        // TODO add your handling code here:
        String sql = "SELECT * into OUTFILE 'C:/Users/Raju/Documents/YearWiseReports/"+txt_Year.getText()+"_Year_Wise_Reports.xls' from issue_books where Issue_Date like '"+txt_Year.getText()+"'";
        try{
            pst=conn.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(rootPane,"Export Sucessfully");
    ...
    }//GEN-LAST:event_btn_month_exportActionPerformed
